...
def jsonfile(filename):
    return jsonf(filename,
                 json.load(open_or_create_file(filename), object_pairs_hook=OrderedDict))
...
class update_term_info(object):
    ...
    def write_term_metadata(self, output_filename, new_json):
        with open_or_create_file(output_filename, 'w') as outfile:
...
class java_term_info(object):
    ...
    def write_output(self):
        with open_or_create_file(self.output_filename, 'w') as outputfile:
